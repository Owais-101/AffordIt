...
const HeroSection = () => {
    return (
        <div className='relative overflow-hidden min-h-fit hero-bg border-2 outline-none rounded-2xl max-md:mx-2 mt-5 px-6 md:px-10 lg:px-16 py-10 lg:py-28 md:py-20 '>
